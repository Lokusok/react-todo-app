...
const Modal: FC<ModalProps> = ({ title, isShow, onClose, children }) => {
  return (
    <div>
      ...
      >
        <Dialog
          className="my-3 max-h-full overflow-y-auto backdrop-blur-sm z-[500] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 fixed w-full h-full flex justify-center items-center"
          onClose={onClose}
        >
          <Dialog.Panel className="shadow-xl min-w-[320] w-full w-[70%] max-w-md rounded-2xl m-auto bg-blue-50">
